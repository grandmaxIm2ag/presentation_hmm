...
\author{Bleuzen Jonathan \and Flora Gautheron \and Maxence Grand} 
\institute{M2 MOSIG }
...
\begin{frame}
  ...
  \begin{array}{ll}
    O_1 =& 2 \\
    b(0_1) =& (0.04, 0.13, 0.9, 0.12)\\ \pause
...
\begin{equation*}
  \begin{array}{ll}
    ...
    = & 0 \\  \pause
    \psi_2 = & \begin{pmatrix} 1 &1 & 1& 1\end{pmatrix}
  \end{array}
\end{equation*}
 \end{frame}
\begin{frame}
...
\begin{frame}
  \frametitle{Methods using HMM}
  \framesubtitle{Anomalybased HMMs\footfullcite{joshi2005investigating}}
  \begin{itemize}
